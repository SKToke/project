    ...
    <div>
        <div class="row mb-3">
            <div class="col-md-3 offset-md-3">
                <button class="btn btn-brand btn-sm btn-flickr fa-pull-right"
                        type="button">
                    <i class="fa fa-plus"></i>
                    <span>Add New</span>
                </button>
                <button class="btn btn-brand btn-sm btn-github fa-pull-right mr-2" @click="addNewProject()"
                        type="button">
                    <i class="fa fa-plus"></i>
            ...
            <div class="col-md-3">
                <button
                    class="btn btn-sm btn-outline-info d-block rounded-0 w-100"
                    type="button">
                    Back
                </button>
            </div>
        ...
        <div class="modal fade" id="addNewProject" tabindex="-1" role="dialog"
             aria-labelledby="viewModalTitle"
             aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content rounded-0">
                    <div class="modal-header">
                        <h6 class="modal-title" id="exampleModalCenterTitle3">Add Project</h6>
                    ...
                    <div class="modal-body">
                        <div>
                            <label class="c-label pt-1">Name<span class="text-danger">*</span></label>
                            <div class="row">
                                <div class="col-md-12">
                                    <input
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-brand btn-sm rounded-0" data-dismiss="modal">
                            Close
                        </button>
                        <div class="py-1">
                            <button
                                @click="submitAddNewProject()"
                                class="btn btn-sm btn-outline-primary d-block rounded-0 w-100"
                                type="button">
                                Submit
                            </button>
                        </div>
