...
!function (t, e) {
    ...
    var v = o(function (t) {
    ...
    }), c = v.document, s = i(c) && i(c.createElement), l = function (t) {
        ...
        return t[e] = n, t
    }, h = {}.hasOwnProperty, g = function (t, e) {
        return h.call(t, e)
    }, y = 0, m = Math.random(), b = function (t) {
        return "Symbol(".concat(void 0 === t ? "" : t, ")_", (++y + m).toString(36))
    }, w = o(function (t) {
        var e = t.exports = {version: "2.5.7"};
        "number" == typeof __e && (__e = e)
    }), O = (w.version, o(function (t) {
        var o = b("src"), e = "toString", n = Function[e], a = ("" + n).split(e);
        ...
        var e = "__core-js_shared__", n = v[e] || (v[e] = {});
        (t.exports = function (t, e) {
            return n[t] || (n[t] = void 0 !== e ? e : {})
        })("versions", []).push({version: w.version, mode: "global", copyright: "© 2018 Denis Pushkarev (zloirock.ru)"})
    }), I = o(function (t) {
        var e = T("wks"), n = v.Symbol, r = "function" == typeof n;
        (t.exports = function (t) {
            return e[t] || (e[t] = r && n[t] || (r ? n : b)("Symbol." + t))
        }).store = e
    }), C = function (e, t, n) {
        var r = I(e), i = n(S, r, ""[e]), o = i[0], a = i[1];
        u(function () {
            var t = {};
            return t[r] = function () {
                return 7
    ...
    }, k = {}.toString, E = function (t) {
        return k.call(t).slice(8, -1)
    }, j = I("match"), x = function (t) {
        var e;
        return i(t) && (void 0 !== (e = t[j]) ? !!e : "RegExp" == E(t))
    };
    C("split", 2, function (i, o, a) {
        var p = x, h = a, v = [].push, t = "split", g = "length", y = "lastIndex";
        if ("c" == "abbc"[t](/(b)*/)[1] || 4 != "test"[t](/(?:)/, -1)[g] || 2 != "ab"[t](/(?:ab)*/)[g] || 4 != "."[t](/(.?)(.?)/)[g] || 1 < "."[t](/()()/)[g] || ""[t](/.?/)[g]) {
            ...
            a = function (t, e) {
                ...
                var r, i, o, a, u, c = [],
                    ...
                    l = 0, f = void 0 === e ? 4294967295 : e >>> 0, d = new RegExp(t.source, s + "g");
                for (m || (r = new RegExp("^" + d.source + "$(?!\\s)", s)); (i = d.exec(n)) && !(l < (o = i.index + i[0][g]) && (c.push(n.slice(l, i.index)), !m && 1 < i[g] && i[0].replace(r, function () {
    ...
    var A = I("unscopables"), P = Array.prototype;
    null == P[A] && L(P, A, {});
    var D = function (t) {
        P[A][t] = !0
    }, M = function (t, e) {
        return {value: e, done: !!t}
    }, R = {}, N = Object("z").propertyIsEnumerable(0) ? Object : function (t) {
    ...
    }, U = "prototype", F = function (t, e, n) {
        var r, i, o, a, u = t & F.F, c = t & F.G, s = t & F.S, l = t & F.P, f = t & F.B,
            d = c ? v : s ? v[e] || (v[e] = {}) : (v[e] || {})[U], p = c ? w : w[e] || (w[e] = {}),
            h = p[U] || (p[U] = {});
    ...
    var q, V = F, K = Math.ceil, H = Math.floor, B = function (t) {
            return isNaN(t = +t) ? 0 : (0 < t ? H : K)(t)
        }, z = Math.min, J = function (t) {
            return 0 < t ? z(B(t), 9007199254740991) : 0
        }, $ = Math.max, W = Math.min, Y = T("keys"), X = function (t) {
            return Y[t] || (Y[t] = b(t))
        }, Z = (q = !1, function (t, e, n) {
            var r, i, o, a = G(t), u = J(a.length), c = (i = u, (r = B(r = n)) < 0 ? $(r + i, 0) : W(r, i));
            if (q && e != e) {
                for (; c < u;) if ((o = a[c++]) != o) return !0
            } else for (; c < u; c++) if ((q || c in a) && a[c] === e) return q || c || 0;
            return !q && -1
        }), tt = X("IE_PROTO"),
        ...
        nt = Object.keys || function (t) {
            ...
            return t
        }, it = v.document, ot = it && it.documentElement, at = X("IE_PROTO"), ut = function () {
        }, ct = "prototype", st = function () {
            var t, e = l("iframe"), n = et.length;
        ...
        }, ft = p.f, dt = I("toStringTag"), pt = function (t, e, n) {
            t && !g(t = n ? t : t.prototype, dt) && ft(t, dt, {configurable: !0, value: e})
        }, ht = {};
    ...
    var vt = function (t) {
        return Object(S(t))
    }, gt = X("IE_PROTO"), yt = Object.prototype, mt = Object.getPrototypeOf || function (t) {
    ...
    }, bt = I("iterator"), wt = !([].keys && "next" in [].keys()), St = "values", _t = function () {
        return this
    }, Lt = function (t, e, n, r, i, o, a) {
        var u, c, s;
        c = e, s = r, (u = n).prototype = lt(ht, {next: _(1, s)}), pt(u, c + " Iterator");
        var l, f, d, p = function (t) {
            ...
            }, h = e + " Iterator", v = i == St, g = !1, y = t.prototype, m = y[bt] || y["@@iterator"] || i && y[i],
            b = m || p(i), w = i ? v ? p("entries") : b : void 0, S = "Array" == e && y.entries || m;
        if (S && (d = mt(S.call(new t))) !== Object.prototype && d.next && (pt(d, h, !0), "function" != typeof d[bt] && L(d, bt, _t)), v && m && m.name !== St && (g = !0, b = function () {
            return m.call(this)
        }), (wt || g || !y[bt]) && L(y, bt, b), R[e] = b, R[h] = _t, i) if (l = {
            values: v ? b : p(St),
            keys: o ? b : p("keys"),
            entries: w
        }, a) for (f in l) f in y || O(y, f, l[f]); else V(V.P + V.F * (wt || g), e, l);
        return l
    ...
    for (var Tt = I("iterator"), It = I("toStringTag"), Ct = R.Array, kt = {
        ...
        var xt, At = Et[jt], Pt = kt[At], Dt = v[At], Mt = Dt && Dt.prototype;
        if (Mt && (Mt[Tt] || L(Mt, Tt, Ct), Mt[It] || L(Mt, It, At), R[At] = Ct, Pt)) for (xt in Ot) Mt[xt] || O(Mt, xt, Ot[xt], !0)
    }
    !function () {
        if ("function" == typeof NodeList.prototype.forEach) return;
        NodeList.prototype.forEach = Array.prototype.forEach
    }();
    var Rt = {f: Object.getOwnPropertySymbols}, Nt = {f: {}.propertyIsEnumerable}, Gt = Object.assign,
        Qt = !Gt || u(function () {
            ...
            for (var n = vt(t), r = arguments.length, i = 1, o = Rt.f, a = Nt.f; i < r;) for (var u, c = N(arguments[i++]), s = o ? nt(c).concat(o(c)) : nt(c), l = s.length, f = 0; f < l;) a.call(c, u = s[f++]) && (n[u] = c[u]);
            return n
        } : Gt;
    V(V.S + V.F, "Object", {assign: Qt});
    var Ut, Ft = (Ut = !0, function (t, e) {
        var n, r, i = String(S(t)), o = B(e), a = i.length;
    ...
    Lt(String, "String", function (t) {
        ...
        return n >= e.length ? {value: void 0, done: !0} : (t = Ft(e, n), this._i += t.length, {value: t, done: !1})
    });
    ...
    }, Vt = I("iterator"), Kt = Array.prototype, Ht = function (t, e, n) {
        e in t ? p.f(t, e, _(0, n)) : t[e] = n
    }, Bt = I("toStringTag"), zt = "Arguments" == E(function () {
        return arguments
    }()), Jt = I("iterator"), $t = w.getIteratorMethod = function (t) {
    ...
    V(V.S + V.F * !function (t, e) {
        ...
        from: function (t) {
            var e, n, r, i, o, a = vt(t), u = "function" == typeof this ? this : Array, c = arguments.length,
                s = 1 < c ? arguments[1] : void 0, l = void 0 !== s, f = 0, d = $t(a);
            if (l && (s = Q(s, 2 < c ? arguments[2] : void 0, 2)), null != d && (u != Array || (void 0 === (o = d) || R.Array !== o && Kt[Vt] !== o))) for (i = d.call(a), n = new u; !(r = i.next()).done; f++) Ht(n, f, l ? qt(i, s, [r.value, f], !0) : r.value); else for (n = new u(e = J(a.length)); f < e; f++) Ht(n, f, l ? s(a[f], f) : a[f]);
            return n.length = f, n
        }
    ...
    var te, ee, ne, re, ie, oe, ae, ue, ce, se, le, fe, de, pe, he, ve, ge, ye, me, be, we, Se, _e, Le, Oe, Te, Ie, Ce,
        ke, Ee, je, xe,
        Ae = (ee = "ajaxLoad", ne = "coreui.ajaxLoad", re = (te = e).fn[ee], ie = "active", oe = "open", ae = "view-script", ue = "click", ce = ".sidebar-nav .nav-dropdown", se = ".sidebar-nav .nav-link", le = ".sidebar-nav .nav-item", fe = ".view-script", de = {
            ...
            return t.loadPage = function (r) {
                var i = this._element, t = this._config;
                te.ajax({
                    type: "GET", url: t.subpagesDirectory + r, dataType: "html", beforeSend: function () {
                        ...
                        }), te("body").animate({scrollTop: 0}, 0), te(i).html(e), n.length && function t(e, n) {
                            void 0 === n && (n = 0);
        ...
        }, _e), Me = Array.isArray || function (t) {
            return "Array" == E(t)
        }, Re = I("species"),
        Ne = (Te = 1 == (Le = 5), Ie = 2 == Le, Ce = 3 == Le, ke = 4 == Le, Ee = 6 == Le, je = 5 == Le || Ee, xe = Oe || function (t, e) {
            ...
            for (var r, i, o = vt(t), a = N(o), u = Q(e, n, 3), c = J(a.length), s = 0, l = Te ? xe(t, c) : Ie ? xe(t, 0) : void 0; s < c; s++) if ((je || s in a) && (i = u(r = a[s], s, o), Le)) if (Te) l[s] = i; else if (i) switch (Le) {
                case 3:
                    return !0;
                case 5:
                    return r;
    ...
    var Ue, Fe, qe, Ve, Ke, He, Be, ze, Je, $e, We, Ye, Xe, Ze, tn, en, nn, rn, on, an, un, cn, sn, ln,
        fn = function (t, e) {
            var n;
            (void 0 === e && (e = document.body), t.match(/^--.*/i) && Boolean(document.documentMode) && 10 <= document.documentMode) ? n = function () {
                for (var r = {}, t = document.styleSheets, e = "", n = t.length - 1; -1 < n; n--) {
                    for (var i = t[n].cssRules, o = i.length - 1; -1 < o; o--) if (".ie-custom-properties" === i[o].selectorText) {
                        e = i[o].cssText;
                        break
                    }
                    if (e) break
    ...
    n && "g" != /./g.flags && p.f(RegExp.prototype, "flags", {configurable: !0, get: pn});
    var hn = "toString", vn = /./[hn], gn = function (t) {
    ...
    }, t.AjaxLoad = Ae, t.AsideMenu = De, t.Sidebar = dn, Object.defineProperty(t, "__esModule", {value: !0})
});
